    ...
    <div class="rounded-lg p-10 w-60%" bg="white dark:gray-700" m="t-10 auto">
      ...
      >
        ...
        <n-form-item
          ...
          :rules="{ required: true, message: 'Please input preprint title', trigger: ['input', 'blur'] }"
        >
          <n-input v-model:value="formValue.title" placeholder="Please input Preprint Title" />
        </n-form-item>
        <n-form-item
          label="Abstract:" path="abstract"
          :rules="{ required: true, message: 'Please input abstract', trigger: ['input', 'blur'] }"
        >
        ...
        <n-form-item
          ...
          :rules="{ required: true, message: 'Please input keywords', trigger: ['input', 'blur'] }"
        >
        ...
        <div flex="~">
          ...
          >
            <n-upload-dragger>
              <div m="b-2">
                <icon i="carbon-document-attachment" text="2xl" />
              </div>
        ...
        <div flex="~ gap-6" justify-center items-center>
          <n-button class="mt-10 w-50" type="primary">
            Submit
          </n-button>
          <n-button class="mt-10 w-50" type="info">
            Save
          </n-button>
          <n-button class="mt-10 w-50">
            Back
          </n-button>
        </div>
      </n-form>
